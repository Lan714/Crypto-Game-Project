...
const Footer = () => {
  return (
    ...
    <div className="col copyright">
      <p className=""><small className="text-white-50">© 2021. All Rights Reserved. Want to find out more about CryptoMaster <a  href="./Pages/AboutUs" className="click">CLICK HERE</a></small></p>
    </div>
  </div>
        </div>
      </div>
